    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-md w-full p-6">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-sm text-gray-800">Share Board</h3>
          <button
            onClick={onClose}
        ...
        <div className="mb-6">
          ...
          {/* Pill Link Container */}
          <div className={`flex items-center justify-between gap-2 px-2 lg:px-4 py-2 rounded-xl border-2 transition-all duration-300 ${
            isCopied 
