...
export default function ServiceImageDisplay({
  ...
  if (hasImage === false) {
    return (
      <div className={`bg-[var(--dashboard-bg-tertiary)] flex items-center justify-center rounded-lg ${className}`}>
        <div className="text-[var(--dashboard-text-secondary)] text-sm text-center">
