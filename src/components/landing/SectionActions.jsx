            ...
            <div className="p-3 bg-gray-50 rounded-lg border">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <span className="text-sm font-medium text-gray-900">123 Business St, Milan</span>
                  </div>
                </div>
          ...
          <div className="space-y-3">
            ...
            <div className="p-3 bg-gray-50 rounded-lg border">
              ...
              <div className="text-xs text-gray-600">
                <span className="font-medium">Signature required to proceed</span>
              </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-gray-500 line-through">Submit initial proposal</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-4 h-4 border-2 border-gray-300 rounded"></div>
