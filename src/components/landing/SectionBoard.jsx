                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-4 lg:gap-6 max-w-6xl mx-auto">
                       ...
                       <div className="bg-white rounded-2xl p-4 md:p-5 lg:p-6 border border-gray-100 md:col-span-2 lg:col-span-1">
                            ...
                            <div className="flex flex-col items-center text-center space-y-2 lg:space-y-4">
                                ...
                                <div className="w-14 h-14 lg:w-20 lg:h-20 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">

                                    <svg className="w-6 h-6 lg:w-10 lg:h-10 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="flex-1">
                                    ...
                                    <h3 className="text-lg font-medium text-gray-900 mb-2 leading-tight lg:leading-relaxed">{t('Board.benefits.unifiedView.title')}</h3>
                       ...
                       <div className="bg-white rounded-2xl p-4 md:p-5 lg:p-6 border border-gray-100">
                            ...
                            <div className="flex flex-col items-center text-center space-y-2 lg:space-y-4">
                                ...
                                <div className="w-14 h-14 lg:w-20 lg:h-20 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0">

                                    <svg className="w-6 h-6 lg:w-10 lg:h-10 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="flex-1">
                                    ...
                                    <h3 className="text-lg font-medium text-gray-900 mb-2 leading-tight lg:leading-relaxed">{t('Board.benefits.clearView.title')}</h3>
                        ...
                        <div className="bg-white rounded-2xl p-4 md:p-5 lg:p-6 border border-gray-100">
                            ...
                            <div className="flex flex-col items-center text-center space-y-2 lg:space-y-4">
                                ...
                                <div className="w-14 h-14 lg:w-20 lg:h-20 rounded-full bg-red-100 flex items-center justify-center flex-shrink-0">

                                    <svg className="w-6 h-6 lg:w-10 lg:h-10 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="flex-1">
                                    ...
                                    <h3 className="text-lg font-medium text-gray-900 mb-2 leading-tight lg:leading-relaxed">{t('Board.benefits.problemSolving.title')}</h3>
                        ...
                        <div className="bg-white rounded-2xl p-4 md:p-5 lg:p-6 border border-gray-100">
                            ...
                            <div className="flex flex-col items-center text-center space-y-2 lg:space-y-4">
                                ...
                                <div className="w-14 h-14 lg:w-20 lg:h-20 rounded-full bg-cyan-100 flex items-center justify-center flex-shrink-0">

                                    <svg className="w-6 h-6 lg:w-10 lg:h-10 text-cyan-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="flex-1">
                                    ...
                                    <h3 className="text-lg font-medium text-gray-900 mb-2 leading-tight lg:leading-relaxed">{t('Board.benefits.effortlessManagement.title')}</h3>
                        ...
                        <div className="bg-white rounded-2xl p-4 md:p-5 lg:p-6 border border-gray-100">
                            ...
                            <div className="flex flex-col items-center text-center space-y-2 lg:space-y-4">
                                ...
                                <div className="w-14 h-14 lg:w-20 lg:h-20 rounded-full bg-purple-100 flex items-center justify-center flex-shrink-0">

                                    <svg className="w-6 h-6 lg:w-10 lg:h-10 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="flex-1">
                                    ...
                                    <h3 className="text-lg font-medium text-gray-900 mb-2 leading-tight lg:leading-relaxed">{t('Board.benefits.automatedNotifications.title')}</h3>
                        ...
                        <div className="bg-white rounded-2xl p-4 md:p-5 lg:p-6 border border-gray-100">
                            ...
                            <div className="flex flex-col items-center text-center space-y-2 lg:space-y-4">
                                ...
                                <div className="w-14 h-14 lg:w-20 lg:h-20 rounded-full bg-yellow-100 flex items-center justify-center flex-shrink-0">

                                    <svg className="w-6 h-6 lg:w-10 lg:h-10 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="flex-1">
                                    ...
                                    <h3 className="text-lg font-medium text-gray-900 mb-2 leading-tight lg:leading-relaxed">{t('Board.benefits.secureAccess.title')}</h3>
