...
export default function MilestoneUpdate({ details }: Props) {
  ...
  return (
    <div className="space-y-3">
      <div className={`flex flex-col w-full p-4 border border-gray-200 rounded-xl ${
        isCompleted 
          ? 'bg-gradient-to-t from-green-100/50 to-white' 
          : 'bg-gradient-to-t from-blue-100/50 to-white'
      }`}>
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center min-w-0 flex-1">
            <div className="min-w-0 flex-1">
              <h3 className="text-base md:text-lg lg:text-xl font-semibold text-gray-900 truncate">
          ...
          <div className="flex-shrink-0 ml-4">
            {isCompleted ? (
              <div className="h-6 w-6 lg:h-8 lg:w-8 rounded-full bg-green-100 flex items-center justify-center">
                <svg className="h-4 lg:h-4 w-5 lg:w-5 text-green-600" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div className="h-6 w-6 lg:h-8 lg:w-8 rounded-full bg-blue-100 flex items-center justify-center">
                <svg className="h-4 lg:h-4 w-5 lg:w-5 text-blue-600" viewBox="0 0 20 20" fill="currentColor">
