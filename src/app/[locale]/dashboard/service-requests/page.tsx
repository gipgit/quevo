            ...
            <div className="grid grid-cols-1 gap-y-6">
              {serviceRequests.map((request) => (
                <div key={request.request_id}>
                                     <div className={`rounded-xl shadow-sm border overflow-hidden grid grid-cols-1 lg:grid-cols-[12%_55%_33%] p-5 lg:p-6 gap-2 lg:gap-4 ${
                     theme === 'dark' 
                    ...
                    <div className="col-span-1">
                      <div className="flex flex-row lg:flex-col gap-3 lg:gap-4">
                        ...
                        <div className="flex items-center gap-2">
                          <span className={`px-3 py-1.5 rounded-full text-xs lg:text-sm font-medium ${getStatusColor(request.status)}`}>
                        ...
                        {/* Request Reference */}
                        <div className="flex items-center gap-2">
                          <span className={`px-2 py-0.5 border-2 rounded-md text-xs lg:text-sm ${
                            theme === 'dark' 
                              ...
                              : 'border-gray-500 bg-zinc-100 text-gray-700'
                                         ...
                                         {/* Request Details - Second Column */}
                     <div className="col-span-1 max-w-lg min-w-[320px]">
                                               <div className="mb-2">
                       ...
                       {request.customer_notes && (
                         <div className="mb-4 break-all">
                           ...
                           <span className="text-xs text-blue-600 ml-1">{request.customer_notes}</span>
                         </div>
                       )}
                          ...
                          <div className="mt-2 w-full break-words break-all min-w-0">
                            ...
                            <div className="text-xs text-gray-400 break-all">
                              No details available
                                                                                    ...
                                                                                    {/* Customer and Open Board Button - Third Column */}
                      <div className="col-span-1 flex flex-col gap-3 items-start min-w-0">
                       
                       {/* Customer Details Row */}
                       <div className="self-start flex-shrink-0 w-full min-w-0">
                         <div className={`border-2 rounded-xl p-3 w-full h-full flex flex-col justify-center min-w-0 ${
                           theme === 'dark' 
                           ...
                           <div className="space-y-1 min-w-0">
                             ...
                             {(request.usercustomer?.email || request.customer_email) && (
                               <div className="flex items-center justify-between min-w-0">
                                 <span className={`text-xs truncate flex items-center gap-1 min-w-0 ${
                                   ...
                                   <EnvelopeIcon className="w-4 h-4 text-gray-400 inline-block flex-shrink-0" />
                                   <span className="truncate">{request.usercustomer?.email || request.customer_email}</span>
                                 </span>
                             ...
                             {(request.usercustomer?.phone || request.customer_phone) && (
                               <div className="flex items-center justify-between mt-1 min-w-0">
                                 <span className={`text-sm truncate flex items-center gap-1 min-w-0 ${
                                   theme === 'dark' ? 'text-gray-300' : 'text-gray-600'
                                 }`}>
                                   <svg className="w-4 h-4 inline-block text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                     <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                   </svg>
                                   <span className="truncate">{request.usercustomer?.phone || request.customer_phone}</span>
                                 </span>
                                 <div className="flex items-center gap-1 ml-2 flex-shrink-0">
                                   <button
