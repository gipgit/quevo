...
import MarketingEmailAssistantWrapper from "./marketing-email-assistant-wrapper"
import { getCurrentBusinessIdFromCookie } from "@/lib/server-business-utils"

export default async function MarketingEmailAssistantPage({
  params
}: {
  ...
  // Fetch existing email campaigns
