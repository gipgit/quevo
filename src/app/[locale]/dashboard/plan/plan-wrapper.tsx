      ...
      <div className="max-w-6xl mx-auto">
              ...
              <div className="mb-6">
                <div className="flex items-center gap-4">
                  {(() => {
                    ...
                    return (
                      <span 
                        className={`inline-block px-6 py-2 text-3xl font-semibold rounded-xl shadow-md flex items-center gap-2 ${planColors.textColor}`}
        ...
        {showPlansModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl max-w-[1400px] w-full max-h-[90vh] overflow-y-auto">
                      ...
                      <div>
                        <div className="mb-4">
                          {(() => {
                            ...
                            return (
                              <span 
                                className={`inline-block px-4 py-2 text-xl font-semibold rounded-xl shadow-md flex items-center gap-2 w-fit ${planColors.textColor}`}
                                style={planColors.style}
                              >
                                {planColors.showStar && (
