  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res?.error) {
        ...
        showError("Errore imprevisto durante l'accesso. Riprova.", "system")
        setLoading(false)
      }
    } catch (err: any) {
      const errorMessage = err.message || "Errore di connessione. Verifica la tua connessione internet."
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 px-4">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Accedi al tuo account manager</p>
      </div>
